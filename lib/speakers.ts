...
export const speakers: Speaker[] = [
  ...
  {
    id: "deon-hanns-jo-hobson",
    name: "Deon Hanns & Jo Hobson",
    role: "Visual Storyteller & Organisational Psychologist",
    company: "The San Scribe",
    country: "South Africa",
    flag: "🇿🇦",
    website: "https://www.thesanscribe.com",
    bio: "Deon Hanns is a Visual Storyteller and Strategic Narrative Architect, founder of The San Scribe. Jo Hobson is an Organisational Psychologist who enables thinking, learning, and performance in people, teams, and organisations. Together they have developed the Neuro Narrative Mapping system — a toolset that translates the Science of Tracking, the sophisticated visual intelligence developed by the San ancestors, into a high-performance framework for modern facilitators.",
  ...
  {
    id: "gill-cromhout-maaike-borsboom",
    name: "Gill Cromhout & Maaike Borsboom",
    role: "Bikablo® Certified Global Trainers",
    company: "Drawn In / INKSIGHT",
    country: "South Africa & Netherlands",
    flag: "🇿🇦🇳🇱",
    website: "https://drawnin.co",
    bio: "Gill Cromhout is the founder of Drawn In (South Africa), a Bikablo® Certified Global Trainer, and Official Reseller of Neuland in South Africa. Maaike Borsboom is the founder of INKSIGHT (Netherlands) and a Bikablo® Certified Global Trainer. Together they create spaces where people feel seen and able to express their thinking with clarity, combining Solution-Focused Dialogues with visualisation to help individuals and groups make their thinking visible.",
  ...
  {
    id: "nora-sheffe-james-durno",
    name: "Nora Sheffe & James Durno",
